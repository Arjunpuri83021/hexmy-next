  ...
  return {
    ...
    twitter: {
      ...(previewVideoUrl ? {
        ...
        images: [imageUrl],
        creator: '@hexmy',
        'twitter:player': `${canonicalBase}/api/player?id=${id}`,
...
export default async function VideoDetailPage({ params, searchParams }) {
  ...
  // Brand salt ensures Hexmy produces different variants than other sites using similar templates
  const brandSalt = 'Hexmy'.split('').reduce((acc, ch) => acc + ch.charCodeAt(0), 0)
                  ...
                  <VideoDescription title={['Video Overview', 'About This Scene', 'Content Description', 'What to expect', 'Scene Details'][contentVariant]}>
                    {video.desc ? (
                      <div className="text-gray-300 leading-relaxed space-y-3">
                        ...
                        <p>
                          On Hexmy, this title is curated with fast-loading playback and clean navigation in mind. Our editors surface similar
                      ...
                      <div className="text-gray-300 leading-relaxed space-y-3">
                        ...
                        <p>
                          Hexmy focuses on efficient browsing and relevant suggestions. After watching, check the related grid below for handpicked
